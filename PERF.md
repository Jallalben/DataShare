...
Les images Docker utilisent Node 24 Alpine pour rester légères. Le code frontend ne charge que ce dont l'utilisateur a besoin au moment où il en a besoin. Les requêtes TypeORM sont écrites pour éviter les jointures inutiles.
